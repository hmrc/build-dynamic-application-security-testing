...
WORKDIR /zap/plugin
ARG ASCANRULES_VERSION=47
ARG ASCANRULESBETA_VERSION=41
ARG PSCANRULES_VERSION=42
ARG PSCANRULESBETA_VERSION=29
ARG RETIRE_VERSION=0.14.0
ARG ALERTFILTERS_VERSION=13
ARG COMMONLIB_VERSION=1.9.0
ARG NETWORK_VERSION=0.2.0
ARG OAST_VERSION=0.10.0
ARG NETWORK_VERSION=0.2.0
RUN rm --force \
    ...
    && wget --quiet \
        ...
        https://github.com/zaproxy/zap-extensions/releases/download/oast-v${OAST_VERSION}/oast-alpha-${OAST_VERSION}.zap \
        https://github.com/zaproxy/zap-extensions/releases/download/network-v${NETWORK_VERSION}/network-alpha-${NETWORK_VERSION}.zap
# Autogenerated END
